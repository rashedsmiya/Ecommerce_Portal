                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <form>
                                    <div class="mb-3">
                                        <div class="form-text mb-2">Please enter your OPT</div>
                                        <input type="tel" class="form-control form-control-lg" placeholder="+91">
                                    </div>
                                    <button href="{{ url('login1') }}" type="submit"
                                        class="btn theme-orange-btn text-light form-control form-control-lg">Request
                                        OTP</button>
                                    <div class="text-center p-5 my-5">Don't Have an Account? <a href="{{ url('register') }}"
                                            class="text-decoration-none">Singup</a></div>
                                </form>
                            </div>
                        </div>
                    </div>
